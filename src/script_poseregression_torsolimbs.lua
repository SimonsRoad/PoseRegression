--[[
--script_poseregression_torsolimbs.lua
...
-- 3. loss function
-- 
criterion = nn.ParallelCriterion():add(nn.MSECriterion(), 12/20):add(nn.MSECriterion(), 8/20)
...
TRAINING = true
if TRAINING then
	paths.dofile('train_torsolimbs.lua')
	paths.dofile('test_torsolimbs.lua')
