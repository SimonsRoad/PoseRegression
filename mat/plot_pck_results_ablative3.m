function plot_pck_results_ablative3()
% plot_pck_results_ablative3.m
% study for the effect of location-specific VS generic
%
clc; close all; clear;

datasetname = 'ablative3';     
...
opt = {
    ...
    {'-',  'd',  sprintf('SPN (G) [%.1f%%]', pck_avg(11,2))}, ...
    };
