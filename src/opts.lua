...
function M.parse(arg)
    ...
    cmd:option('-txtimg',      '../data/rendout/anc_y262_x544/lists/img_pos.txt',  'img list')
    cmd:option('-txtjsc',      '../data/rendout/anc_y262_x544/lists/jsc_pos.txt',  'jsc list')
    cmd:option('-nTrainData',     50000,  'number of train data')
    cmd:option('-nTestData',        500,  'number of test data')
    cmd:option('-y',                262,  'y coordinate of anchor location')
    cmd:option('-x',                544,  'x coordinate of anchor location')
    cmd:option('-W',                 98,  'image width')
    cmd:option('-H',                141,  'image height')
    cmd:option('-W_jsc',             98,  'jsc width')
    cmd:option('-H_jsc',            141,  'jsc height')
